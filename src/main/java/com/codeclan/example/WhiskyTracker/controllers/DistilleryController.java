...
public class DistilleryController {
    ...
    @GetMapping(value = "/distillery/whiskies/{age}")
    ...
    @GetMapping(value = "/distillery/whiskies/age12")
    public List<Distillery> findDistileryByWhiskyAge12(){
        return distilleryRepository.findDistilleryThatHaveWhiskiesAge12();
    }
